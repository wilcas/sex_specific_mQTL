...
cord_mqtl_job=$(qsub -v MQTL="${coord_mqtl}",Z_dir="/scratch/st-dennisjk-1/wcasazza/delahaye_QC/caviar_files/cord_mqtl",FILE_PREFIX="/scratch/st-dennisjk-1/wcasazza/1000G_phase3_ldsc/single_delahaye_annotations/coord_mqtl" run_caviar_merge.pbs) 
# @todo finish ldscore pipeline code after caviar pipeline
