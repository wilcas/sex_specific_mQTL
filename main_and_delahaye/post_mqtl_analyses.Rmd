...
ggplot(robinson_matched, aes(-log10(`p-value.x`),-log10(`p-value.y`))) + geom_point() + labs(x="Robinson Interaction", y= "Delahaye Interaction")
```
delahaye and robinson:
```{r}
...
ggplot(delahaye_matched, aes(-log10(`p-value.x`),-log10(`p-value.y`))) + geom_point() + labs(x="Delahaye Interaction", y = "Robinson Interaction") + coord_flip()
...
1 - qvalue::pi0est(delahaye_matched$`p-value.x`,m=nrow(delahaye_matched))$pi0
delahaye_matched[FDR.x < 0.05]
ggplot(delahaye_matched, aes(-log10(`p-value.x`),-log10(`p-value.y`))) + geom_point() + labs(x="Delahaye Interaction", y = "RICHS Interaction") + coord_flip()
```
